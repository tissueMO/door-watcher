...
if __name__ == "__main__":
    ...
    # トイレマスター
    session.add_all([
        Toilet(id=11, name="4F 男性用トイレ", valid=False, is_closed=False, modified_time=now),
        Toilet(id=21, name="6F 男性用トイレ", valid=True, is_closed=False, modified_time=now),
        Toilet(id=31, name="4F 女性用トイレ", valid=False, is_closed=False, modified_time=now),
        Toilet(id=32, name="4F 女性用トイレ", valid=False, is_closed=False, modified_time=now),
        Toilet(id=41, name="6F 女性用トイレ", valid=False, is_closed=False, modified_time=now),
        Toilet(id=42, name="6F 女性用トイレ", valid=False, is_closed=False, modified_time=now)
    ])
